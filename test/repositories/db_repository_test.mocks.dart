...
// in yummy/test/repositories/db_repository_test.dart.
...
import 'package:yummy/data/finance_db.dart' as _i3;
...
class _Fake$DbTripTable_1 extends _i1.SmartFake implements _i3.$DbTripTable {
  _Fake$DbTripTable_1(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class _Fake$DbExpenseTable_2 extends _i1.SmartFake
    implements _i3.$DbExpenseTable {
  _Fake$DbExpenseTable_2(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _FakeTripDao_3 extends _i1.SmartFake implements _i3.TripDao {
  _FakeTripDao_3(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class _FakeExpenseDao_4 extends _i1.SmartFake implements _i3.ExpenseDao {
  _FakeExpenseDao_4(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class _Fake$FinanceDatabaseManager_5 extends _i1.SmartFake
    implements _i3.$FinanceDatabaseManager {
  _Fake$FinanceDatabaseManager_5(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _FakeFinanceDatabase_22 extends _i1.SmartFake
    implements _i3.FinanceDatabase {
  _FakeFinanceDatabase_22(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class MockFinanceDatabase extends _i1.Mock implements _i3.FinanceDatabase {
  ...
  @override
  _i3.$DbTripTable get dbTrip => (super.noSuchMethod(
        Invocation.getter(#dbTrip),
        returnValue: _Fake$DbTripTable_1(
          this,
          Invocation.getter(#dbTrip),
        ),
        returnValueForMissingStub: _Fake$DbTripTable_1(
          this,
          Invocation.getter(#dbTrip),
        ),
      ) as _i3.$DbTripTable);
  ...
  @override
  _i3.$DbExpenseTable get dbExpense => (super.noSuchMethod(
        Invocation.getter(#dbExpense),
        returnValue: _Fake$DbExpenseTable_2(
          this,
          Invocation.getter(#dbExpense),
        ),
        returnValueForMissingStub: _Fake$DbExpenseTable_2(
          this,
          Invocation.getter(#dbExpense),
        ),
      ) as _i3.$DbExpenseTable);

  @override
  _i3.TripDao get tripDao => (super.noSuchMethod(
        Invocation.getter(#tripDao),
        returnValue: _FakeTripDao_3(
          this,
          Invocation.getter(#tripDao),
        ),
        returnValueForMissingStub: _FakeTripDao_3(
          this,
          Invocation.getter(#tripDao),
        ),
      ) as _i3.TripDao);
  ...
  _i3.ExpenseDao get expenseDao => (super.noSuchMethod(
        ...
        returnValue: _FakeExpenseDao_4(
          this,
          Invocation.getter(#expenseDao),
        ),
        returnValueForMissingStub: _FakeExpenseDao_4(
          this,
          Invocation.getter(#expenseDao),
        ),
      ) as _i3.ExpenseDao);
  ...
  _i3.$FinanceDatabaseManager get managers => (super.noSuchMethod(
        ...
        returnValue: _Fake$FinanceDatabaseManager_5(
          this,
          Invocation.getter(#managers),
        ),
        returnValueForMissingStub: _Fake$FinanceDatabaseManager_5(
          this,
          Invocation.getter(#managers),
        ),
  ...
  _i2.Selectable<_i2.TypedResult> selectExpressions(
      ...
      (super.noSuchMethod(
        ...
        returnValue: _FakeSelectable_19<_i2.TypedResult>(
          this,
          Invocation.method(
            #selectExpressions,
            [columns],
        ...
        returnValueForMissingStub: _FakeSelectable_19<_i2.TypedResult>(
          this,
          Invocation.method(
            #selectExpressions,
            [columns],
...
class MockTripDao extends _i1.Mock implements _i3.TripDao {
  @override
  _i3.FinanceDatabase get attachedDatabase => (super.noSuchMethod(
        Invocation.getter(#attachedDatabase),
        returnValue: _FakeFinanceDatabase_22(
          this,
          Invocation.getter(#attachedDatabase),
        ),
        returnValueForMissingStub: _FakeFinanceDatabase_22(
          this,
          Invocation.getter(#attachedDatabase),
        ),
      ) as _i3.FinanceDatabase);
  ...
  @override
  _i5.Future<List<_i7.Trip>> findAllTrips() => (super.noSuchMethod(
        Invocation.method(
          #findAllTrips,
          [],
        ),
        returnValue: _i5.Future<List<_i7.Trip>>.value(<_i7.Trip>[]),
        returnValueForMissingStub:
            _i5.Future<List<_i7.Trip>>.value(<_i7.Trip>[]),
      ) as _i5.Future<List<_i7.Trip>>);

  @override
  _i5.Stream<List<_i7.Trip>> watchAllTrips() => (super.noSuchMethod(
        Invocation.method(
          #watchAllTrips,
          [],
        ),
        returnValue: _i5.Stream<List<_i7.Trip>>.empty(),
        returnValueForMissingStub: _i5.Stream<List<_i7.Trip>>.empty(),
      ) as _i5.Stream<List<_i7.Trip>>);

  @override
  _i5.Future<int> insertTrip(_i3.DbTripCompanion? trip) => (super.noSuchMethod(
        Invocation.method(
          #insertTrip,
          [trip],
        ),
  ...
  @override
  _i5.Future<dynamic> deleteTrip(int? id) => (super.noSuchMethod(
        Invocation.method(
          #deleteTrip,
          [id],
        ),
...
class MockExpenseDao extends _i1.Mock implements _i3.ExpenseDao {
  ...
  @override
  _i5.Future<List<_i7.Expense>> findAllExpenses() => (super.noSuchMethod(
        Invocation.method(
          #findAllExpenses,
          [],
        ),
        returnValue: _i5.Future<List<_i7.Expense>>.value(<_i7.Expense>[]),
        returnValueForMissingStub:
            _i5.Future<List<_i7.Expense>>.value(<_i7.Expense>[]),
      ) as _i5.Future<List<_i7.Expense>>);

  @override
  _i5.Stream<List<_i7.Expense>> watchAllExpenses() => (super.noSuchMethod(
        Invocation.method(
          #watchAllExpenses,
          [],
        ),
        returnValue: _i5.Stream<List<_i7.Expense>>.empty(),
        returnValueForMissingStub: _i5.Stream<List<_i7.Expense>>.empty(),
      ) as _i5.Stream<List<_i7.Expense>>);

  @override
  _i5.Future<int> insertExpense(_i3.DbExpenseCompanion? expense) =>
      (super.noSuchMethod(
        Invocation.method(
          #insertExpense,
          [expense],
  ...
  @override
  _i5.Future<dynamic> deleteExpense(int? id) => (super.noSuchMethod(
        Invocation.method(
          #deleteExpense,
          [id],
        ),
  ...
  @override
  _i5.Future<dynamic> deleteExpensesForTrip(int? tripId) => (super.noSuchMethod(
        Invocation.method(
